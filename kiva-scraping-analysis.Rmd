...
pilot_loan_ids <- unique(pilot_results$id)

observations %>%
  mutate(id = as.character(id)) %>%
  filter(id %in% pilot_loan_ids) %>%
  filter(time >= "2019-05-22 12:00:00") %>%
...
observations %>%
  mutate(id = as.character(id)) %>%
  filter(id %in% pilot_loan_ids) %>%
  filter(time >= "2019-05-22 18:00:00" & time <= "2019-05-22 22:00:00") %>%
  ggplot() +
...
observations %>%
  mutate(id = as.character(id)) %>%
  filter(time >= "2019-05-23 02:45:00" & time <= "2019-05-23 03:00:00") %>%
